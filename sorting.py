...
def Generate():
    ...
    drawData(data,['cyan' for i in range(len(data))])
...
relief=SUNKEN,activebackground="#059458",activeforeground="white",bd=5,width=10,command=Generate)
...
start=Button(root,text="Start",bg="#C45809",font=("arial",12,"italic bold"),
relief=SUNKEN,activebackground="#059458",activeforeground="white",bd=5,width=10,command=Start_Algorithm)
...
speedscale=Scale(root,from_=0.1,to=5.0,length=200,digits=2,resolution=0.2,orient=HORIZONTAL,font=("arial",14,"italic bold"),
relief=GROOVE,bd=2,width=10)
